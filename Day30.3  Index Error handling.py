...
# Example Output
#  Fruit pie
# IMPORTANT: The exception handling should NOT allow each fruit to be printed when there is an exeption.
# e.g. it should not print out Apple pie, Pear pie and Orange pie, when there is an exerception it should only print "Fruit pie".
